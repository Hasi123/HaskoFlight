...
public:
  ...
  /* blocking methods below (wait for transfer finished) */
  ...
  uint8_t readByte(uint8_t address, uint8_t regAddr);
  bool writeByte(uint8_t address, uint8_t regAddr, uint8_t data);
  int16_t readWord(uint8_t address, uint8_t regAddr);
  bool writeWord(uint8_t address, uint8_t regAddr, int16_t data);
  bool writeWords(uint8_t address, uint8_t regAddr, uint8_t count, int16_t* data);
  bool sendCMD(uint8_t address, uint8_t cmd);
