...
public:
  ...
  void init(void);
  bool newData(void);
  int32_t getQuat(const uint8_t index);
  int16_t getAccel(const uint8_t index);
  int16_t getGyro(const uint8_t index);
...
private:
  ...
  /*uint8_t volatile fifoCount[2];
  uint8_t constexpr mpuReadFifoCount[5] PROGMEM = { INTTW_ACTION(MPU6050_ADDRESS, INTTW_WRITE),
                                                INTTW_DEST(1, INTTW_IN_CMD),
                                                MPU6050_RA_FIFO_COUNTH,
                                                INTTW_ACTION(MPU6050_ADDRESS, INTTW_READ),
                                                INTTW_DEST(2, INTTW_AT_POINTER) };
  void mpuGetFIFOcount(void);
  void mpuCheckFIFOcount(void);*/
  static constexpr uint8_t mpuReadFifo[5] PROGMEM = { INTTW_ACTION(MPU6050_ADDRESS, INTTW_WRITE),
                                                      INTTW_DEST(1, INTTW_IN_CMD),
                                                      MPU6050_RA_FIFO_R_W,
                                                      INTTW_ACTION(MPU6050_ADDRESS, INTTW_READ),
                                                      INTTW_DEST(MPU6050_FIFO_LENGTH, INTTW_AT_POINTER) };
  void m_mpuGetFIFO(void);
